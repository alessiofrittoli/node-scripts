# Contributing to Post Install Scripts 🫧

We’re excited that you’re interested in contributing to Post Install Scripts! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/post-install-scripts/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/post-install-scripts).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/post-install-scripts.git
```
...
Thank you for helping improve Post Install Scripts! 🎉