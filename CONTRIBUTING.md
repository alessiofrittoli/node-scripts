# Contributing to Node.js Scripts 🫧

We’re excited that you’re interested in contributing to Node.js Scripts! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/node-scripts/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/node-scripts).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/node-scripts.git
```
...
Thank you for helping improve Node.js Scripts! 🎉